...
const reviews = [
  {
    ...
    text: "Салон Mary радует меня стабильно высоким качеством услуг. Я возвращаюсь снова и снова благодаря профессионализму мастеров.",
    image:
  ...
  },
  {
    name: "Полли Грей",
    role: "Стилист: Перри Джонас",
    text: "В салоне Mary нам с мамой сделали невероятное преображение волос. Все было выполнено очень аккуратно и профессионально.",
    image:
